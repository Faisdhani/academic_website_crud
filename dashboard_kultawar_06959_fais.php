...
$result_total = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM kultawar");
...
$result = mysqli_query($koneksi, "SELECT * FROM kultawar LIMIT $start, $limit");
?>
...
<div class="container">
    <h2 class="text-center my-4 custom-heading">Daftar Penawaran Mata Kuliah Tawar</h2>
    <div class="text-center"><a class="btn btn-primary btn-lg shadow-lg rounded-pill text-white" href="printkultar_06959_fais.php"><i class="fas fa-print me-2"></i>Print</a></div>
    <div class="d-flex justify-content-between mb-4">
        <a href="tambah_kultar_06959_fais.php" class="btn btn-success"><i class="fas fa-plus-circle"></i> Tambah Kuliah Tawar</a>
        <form class="form-inline" role="search">
            <input class="form-control mr-2" type="search" id="searchInput" placeholder="Cari Kuliah Tawar..." aria-label="Search">
                    ...
                    <?php while($row = mysqli_fetch_assoc($result)): ?>
                        <tr class="data-container">
                            ...
                            <td class="action-links">
                                <a href="editkultar_06959_fais.php?idkultawar=<?= $row['idkultawar']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                <a href="hapuskultar_06959_fais.php?idkultawar=<?= $row['idkultawar']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?');"><i class="fas fa-trash-alt"></i> Hapus</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
